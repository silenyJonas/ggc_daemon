...
class BaronTab(BaseTab, ttk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.attack_delay = tk.IntVar(value=20)
        self.wait_after_world = tk.IntVar(value=8)  # Default 8 minut

        # Pozice v seznamu hradů
        self.pos_green = tk.IntVar(value=1)
        self.pos_winter = tk.IntVar(value=3)
        self.pos_sand = tk.IntVar(value=4)
        self.pos_fire = tk.IntVar(value=5)
    ...
    def create_widgets(self):
        ...
        # Řádek pro Časy (Delay a Pauza mezi světy)
        ...
        worlds_pos = [("Zelí:", self.pos_green), ("Zima:", self.pos_winter),
